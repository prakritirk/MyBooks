...
import com.example.android.mybooks.BookContract;
import com.example.android.mybooks.BookContract.BookEntry;
import com.example.android.mybooks.BookDbHelper;
...
public class BookProvider extends ContentProvider {
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        if (price != null && price < 0) {
            throw new IllegalArgumentException( "Book's price cannot be negative value" );
        }
    ...
    private int updateBook(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if ((values.containsKey( BookEntry.COLUMN_BOOK_PRICE ))) {
            ...
            if (price != null && price < 0) {
                ...
                throw new IllegalArgumentException( "Book price cannot have a negative value" );
            }
        }
